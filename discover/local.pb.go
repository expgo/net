...
type Announce struct {
	ID         github_com_syncthing_syncthing_lib_protocol.DeviceID `protobuf:"bytes,1,opt,name=id,proto3,customtype=github.com/expgo/net/protocol.DeviceID" json:"id" xml:"id"`
