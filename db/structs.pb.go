...
type FileInfoTruncated struct {
	...
	ModifiedBy github_com_syncthing_syncthing_lib_protocol.ShortID `protobuf:"varint,12,opt,name=modified_by,json=modifiedBy,proto3,customtype=github.com/expgo/net/protocol.ShortID" json:"modifiedBy" xml:"modifiedBy"`
